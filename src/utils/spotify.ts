...
export const getTopArtistsShort = () =>
  axios.get('/top/artists?limit=20&time_range=short_term', { ...requestConfig });

export const getTopArtistsMedium = () =>
  axios.get('/top/artists?limit=30&time_range=medium_term', { ...requestConfig });
...
export const getTopTracksShort = () =>
  axios.get('/top/tracks?limit=20&time_range=short_term', { ...requestConfig });

export const getTopTracksMedium = () =>
  axios.get('/top/tracks?limit=30&time_range=medium_term', { ...requestConfig });
